...
public class CherryBomb extends Plant {
    ...
    public CherryBomb(int x, int y, int column, int row) {
        super(x, y, 90, 68, "/assets/gif/anim_cherrybomb.gif", 4, column, row);
    }
    ...
    public void buildImage(GridPane lawn) {
        ...
        cherry.setImage(new Image(Objects.requireNonNull(this.getClass().getResource("/assets/gif/powie.gif")).toExternalForm(), 180, 160, false, false));
//        cherry = new ImageView(new Image("/assets/gif/powie.gif", 180, 160, false, false));
        cherry.setX(x - 40);
        cherry.setY(y - 20);
    ...
    public void attacking(Pane pane) {
        ...
        new Thread(() -> {
            ...
            Media blast = new Media(Objects.requireNonNull(getClass().getResource("/assets/sounds/cherrybomb.wav")).toString());
