...
public class SideElement extends Entity {
    ...
    public static void getSideElements(int level, Pane pane) {
        ...
        if (level >= 1) {
            path = "/assets/images/sunflowerCard.png";
            x = 24;
            y = 79;
        ...
        x = 22;
        if (level >= 1) {
            path = "/assets/images/peashooterCard.png";
            y = 147;
        ...
        if (level >= 2) {
            path = "/assets/images/wallnutCard.png";
            y = 217;
        ...
        if (level >= 3) {
            path = "/assets/images/cherrybombCard.png";
            y = 284;
        ...
        if (level >= 4) {
            path = "/assets/images/repeaterCard.png";
            x = 23;
            y = 352;
        ...
        if (level >= 5) {
            path = "/assets/images/chilliPepperCard.png";
            x = 24;
            y = 420;
        ...
        String border_path = Objects.requireNonNull(SideElement.class.getResource("/assets/images/selectedCardBorder.png")).toString();
    ...
    public void setDisabledOn(Pane pane) {
        isDisabled = true;
        ImageView image = new ImageView(new Image(Objects.requireNonNull(getClass().getResource("/assets/images/lock.png")).toString(), 50.0, 50.0, false, false));
        image.setX(getX() + 20);
        image.setY(getY());
