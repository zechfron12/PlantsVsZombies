...
public class GameController {
    ...
    public static List<Integer> zombieList1;
    
    public static List<Integer> zombieList2;
    ...
    public void initialize() {
        Media wave = new Media(Objects.requireNonNull(getClass().getClassLoader().getResource("assets/sounds/zombies_are_coming.wav")).toExternalForm());
    ...
    public void initializeData(int level, GameData gameData) {
        ...
        if (LevelMenuController.status) {
            ...
            String lawnPath = Objects.requireNonNull(getClass().getResource("/assets/images/lawn_night.png")).toString();
    ...
    public void spawnZombies(List<Integer> zombies, int lane, int laneNumber) {
    ...
    public void zombieSpawner1(Random rand, double time) {
        ...
        spawnZombie1.setCycleCount(Animation.INDEFINITE);
        spawnZombie1.play();
    ...
    public void zombieSpawner2(Random rand, double time) {
        ...
        spawnZombie2.setCycleCount(Animation.INDEFINITE);
        spawnZombie2.play();
    ...
    public void getGridPosition(MouseEvent event) {
        ...
        if (!shovel.IsDisabled() && colIndex != null && rowIndex != null) {
                Media jostle = new Media(Objects.requireNonNull(getClass().getResource("/assets/sounds/plant.wav")).toString());
        ...
        if (SideElement.getCardSelected() != -1) {
            if (colIndex != null && rowIndex != null) {
                ...
                if (drop && SideElement.getElement(SideElement.getCardSelected()).getCost() <= sunCount ) {
    ...
    public void dropPlant(int value, int x, int y, int col, int row) {
        Plant plant;
        Media plantSound = new Media(Objects.requireNonNull(getClass().getResource("/assets/sounds/plant.wav")).toString());
